-- Database Schema for AgroLink Farmer Marketplace
...
CREATE TABLE IF NOT EXISTS users (
    ...
    pincode VARCHAR(20),
    role VARCHAR(50), -- 'Farmer' or 'Buyer'
    system_role VARCHAR(50), -- 'ADMIN' or 'USER'
...
CREATE TABLE IF NOT EXISTS crops (
    ...
    price VARCHAR(50), -- Storing as string to keep currency/unit flexibility if needed, or stick to DECIMAL
